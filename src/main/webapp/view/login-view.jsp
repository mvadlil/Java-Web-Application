<%-- 
    Document   : login-view
    Created on : Nov 18, 2020, 8:37:27 PM
    Author     : fadli
--%>
...
<html lang="en">
    ...
    <body class="bg-dark pt-5">
        ...
        <div class="login-container text-c animated flipInX mt-5">
                <h3 class="text-whitesmoke">Please Input Username and Password to Login</h3>
            <div class="container-content">
                ...
                <a class="text-darkyellow" href="register"><button class="form-button button-l margin-b">Sign Up</button></a>
            </div>
        </div>
        <!-- End Form Login -->
