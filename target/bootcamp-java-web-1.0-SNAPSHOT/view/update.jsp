<%-- 
    Document   : update
    Created on : Nov 21, 2020, 2:15:58 PM
    Author     : fadli
--%>
...
<html lang="en">
    ...
    <body class="bg-dark pt-5">
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand JQuery-scroll" href="#home">${userName}</a>
        ...
        <div class="login-container text-c animated flipInX mt-5">
                <h3 class="text-whitesmoke">Update Person</h3>
            <div class="container-content">
                <form class="margin-t" action="update" method="post" onsubmit="validateForm()">
                    <p id="error" style="color: white">${error}</p>
                    <div class="form-group">
                        <input type="text" class="form-control" value="${person.name}" disabled name="userName">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="form-button button-l margin-b">Update Password</button>
                </form>
            </div>
        </div>
        <!-- End Form Login -->
...
<!--        <h1>Update Person</h1>
        <form action="update" method="post" onsubmit="validateForm()">
            ...
            <br/><input type="hidden" name="id" value="${person.id}">
            <br/><input type="hidden" name="name" value="${person.name}">
        ...
        <script>
            function validateForm() {
                const validForm = validatePasswordAndConfirmPasswordIsTheSame();
                if( !validForm ) {
